...
public class CircleTextProgressbar extends android.support.v7.widget.AppCompatTextView {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        ColorStateList colorStateList = typedArray.getColorStateList(R.styleable.CircleTextProgressbar_inCircleColor);
        inCircleColors = colorStateList == null ? ColorStateList.valueOf(Color.TRANSPARENT) : colorStateList;
...
//        Log.d("ttttt", "width" + width  + ", height : " + height  + ", size : " + size);
    ...
    private Runnable progressChangeTask = new Runnable() {
        ...
        public void run() {
            ...
            if (progress >= 0 && progress <= maxProgress) {
                ...
                invalidate();
                postDelayed(progressChangeTask, progressChangeDuration == 0 ? timeMillis / 100 : progressChangeDuration);
            } else
